...
You need to know the dimensions of this checkerboard, specifically the checkerboard square's size and the layout of the squares. You will need to adjust the script [`cam_intrinsic.py`](https://github.com/ACFR-RPG/camera_2d_lidar_calibration/blob/main/camera_2d_lidar_calibration/cam_intrinsic.py#L31) to reflect that. 
